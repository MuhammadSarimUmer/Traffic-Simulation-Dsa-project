/****************************************************************************
** Meta object code from reading C++ file 'signup_dialog.h'
**
...
#error "The header file 'signup_dialog.h' doesn't include <QObject>."
...
template <> constexpr inline auto SignUpDialog::qt_create_metaobjectdata<qt_meta_tag_ZN12SignUpDialogE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "on_toggleConfirmPasswordButton_clicked"
    };
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_togglePasswordButton_clicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_toggleConfirmPasswordButton_clicked'
...
void SignUpDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->on_togglePasswordButton_clicked(); break;
        case 4: _t->on_toggleConfirmPasswordButton_clicked(); break;
        default: ;
        }
    }
    (void)_a;
